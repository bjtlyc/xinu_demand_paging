...
typedef struct fr_map{
  ...
  struct fr_map * next;     //newly add 
  unsigned long int fr_loadtime;	/* when the page is loaded 	*/
}fr_map_t;

extern bs_map_t bsm_tab[];
extern fr_map_t frm_tab[]; // used to maintained the mapping of memory frame
extern fr_map_t fifoq;// use to queue the frame 
extern fr_map_t * lastfifoq;// point to the last element of the fr_tab 
